		...
		*/
		_required: function(field, rules, i, options, condRequired) {
			switch (field.prop("type")) {
				...
				default:
					if (! $.trim(field.val()) && !(field.attr("data-validation-placeholder") && field.val() == field.attr("data-validation-placeholder")) || !(field.attr("placeholder") && field.val() != field.attr("placeholder")))
